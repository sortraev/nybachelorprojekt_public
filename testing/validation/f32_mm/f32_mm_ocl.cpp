                                    ...
                                    unsigned char *mem_628)
{
    ...
    int32_t ltid_x_119 = ltid_pre_663;
    int32_t ltid_y_120 = ltid_pre_664;
    ...
    __local char *mem_545;
    
    mem_545 = (__local char *) mem_545_backing_0;
    
    __local char *mem_548;
    
    mem_548 = (__local char *) mem_548_backing_1;
    ...
    for (int32_t i_142 = 0; i_142 < full_tiles_141; i_142++) {
        ...
        for (int32_t i_147 = 0; i_147 < Ry_93; i_147++) {
            ...
            for (int32_t i_149 = 0; i_149 < tk_div_tx_96; i_149++) {
                ...
                int32_t ltid_x_151 = ltid_pre_663;
                int32_t ltid_y_152 = ltid_pre_664;
                int32_t ltid_flat_153 = local_tid_659;
                int32_t k_169 = ltid_y_152 + binop_y_168;
                int32_t i_171 = ltid_x_151 + binop_y_170;
        ...
        for (int32_t i_187 = 0; i_187 < tk_div_ty_99; i_187++) {
            ...
            for (int32_t i_189 = 0; i_189 < Rx_92; i_189++) {
                ...
                int32_t ltid_x_191 = ltid_pre_663;
                int32_t ltid_y_192 = ltid_pre_664;
                int32_t ltid_flat_193 = local_tid_659;
                int32_t k_209 = ltid_x_191 + binop_y_208;
                int32_t j_211 = ltid_y_192 + binop_y_210;
        ...
        for (int32_t i_227 = 0; i_227 < Tk_89; i_227++) {
            ...
            int32_t ltid_x_229 = ltid_pre_663;
            int32_t ltid_y_230 = ltid_pre_664;
            int32_t ltid_flat_231 = local_tid_659;
            float mem_564[Ry_93];
            float mem_567[Rx_92];
            int32_t binop_x_257 = Ry_93 * ltid_x_229;
            ...
            int32_t binop_y_268 = Rx_92 * ltid_y_230;
            ...
            int32_t ltid_x_274 = ltid_pre_663;
            int32_t ltid_y_275 = ltid_pre_664;
    ...
    for (int32_t i_325 = 0; i_325 < Ry_93; i_325++) {
        ...
        for (int32_t i_327 = 0; i_327 < tk_div_tx_96; i_327++) {
            ...
            int32_t ltid_x_329 = ltid_pre_663;
            int32_t ltid_y_330 = ltid_pre_664;
            int32_t ltid_flat_331 = local_tid_659;
            int32_t k_349 = ltid_y_330 + binop_y_348;
            int32_t i_351 = ltid_x_329 + binop_y_350;
    ...
    for (int32_t i_369 = 0; i_369 < tk_div_ty_99; i_369++) {
        ...
        for (int32_t i_371 = 0; i_371 < Rx_92; i_371++) {
            ...
            int32_t ltid_x_373 = ltid_pre_663;
            int32_t ltid_y_374 = ltid_pre_664;
            int32_t ltid_flat_375 = local_tid_659;
            int32_t k_393 = ltid_x_373 + binop_y_392;
            int32_t j_395 = ltid_y_374 + binop_y_394;
    ...
    for (int32_t i_413 = 0; i_413 < Tk_89; i_413++) {
        ...
        if (cond_416) {
            ...
            int32_t ltid_x_417 = ltid_pre_663;
            int32_t ltid_y_418 = ltid_pre_664;
            int32_t ltid_flat_419 = local_tid_659;
            float mem_601[Ry_93];
            float mem_604[Rx_92];
            int32_t binop_x_445 = Ry_93 * ltid_x_417;
            ...
            int32_t binop_y_456 = Rx_92 * ltid_y_418;
            ...
            int32_t ltid_x_462 = ltid_pre_663;
            int32_t ltid_y_463 = ltid_pre_664;
    ...
    int32_t reg_tile_i_710 = squot32(local_tid_659, Tx_90);
    int32_t reg_tile_i_711 = local_tid_659 - squot32(local_tid_659, Tx_90) *
            Tx_90;
    int32_t tile_dim_start_712 = Ry_93 * (Ty_91 * gid_y_115 + reg_tile_i_710);
    int32_t tile_dim_start_713 = Rx_92 * (Tx_90 * gid_x_114 + reg_tile_i_711);
    
    for (int32_t i_714 = 0; i_714 < Ry_93; i_714++) {
        for (int32_t i_715 = 0; i_715 < Rx_92; i_715++) {
int r = (tile_dim_start_712 + i_714);
int c = (tile_dim_start_713 + i_715);
if (r < M_38 && c < N_41)
            ((__global float *) mem_628)[ r* N_41 +c
                                         ] =
